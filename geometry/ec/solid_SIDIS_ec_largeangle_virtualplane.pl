...
{
make_solid_SIDIS_ec_largeangle_virtualplane_front();
# make_solid_SIDIS_ec_largeangle_virtualplane_middle();
make_solid_SIDIS_ec_largeangle_virtualplane_inner();
make_solid_SIDIS_ec_largeangle_virtualplane_rear();
}

sub make_solid_SIDIS_ec_largeangle_virtualplane_front
{
...
sub make_solid_SIDIS_ec_largeangle_virtualplane_middle
{
 my %detector=init_det();
...
sub make_solid_SIDIS_ec_largeangle_virtualplane_inner
{
 my %detector=init_det();
...
sub make_solid_SIDIS_ec_largeangle_virtualplane_rear
{
 my %detector=init_det();
