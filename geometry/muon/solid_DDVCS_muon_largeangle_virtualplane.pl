...
{
make_solid_DDVCS_muon_largeangle_virtualplane_endcapdonut_0();
...
sub make_solid_DDVCS_muon_largeangle_virtualplane_endcapdonut_0
{
 my %detector=init_det();
 $detector{"name"}        = "$DetectorName\_0";
 $detector{"mother"}      = "root";
 $detector{"description"} = $detector{"name"};
 $detector{"pos"}         = "0*cm 0*cm 209.005*cm";
