...
$configuration{"detector_name"} = "solid_DDVCS_JPsi_LH2";
...
solid_solenoid();
require "solid_JPsi_target_LH2.pl";
solid_JPsi_target_LH2();
require "solid_JPsi_beamline.pl";
solid_JPsi_beamline();
...
require "solid_JPsi_muon_forwardangle.pl";
solid_JPsi_muon_forwardangle();
...
require "solid_SIDIS_spd_largeangle.pl";
solid_SIDIS_spd_largeangle();
...
require "solid_JPsi_virtualplane_muon.pl";
solid_JPsi_virtualplane_muon();
