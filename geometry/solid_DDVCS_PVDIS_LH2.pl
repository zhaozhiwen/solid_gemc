...
$configuration{"detector_name"} = "solid_DDVCS_PVDIS_LH2";
...
#require "solid_PVDIS_target_DDVCS_LH2_enclosure.pl";
#solid_PVDIS_target_DDVCS_LH2_enclosure();
