...
$configuration{"detector_name"} = "solid_PVDIS_target_enclosure";
...
#Geometry definition
require "solid_PVDIS_target_enclosure_geometry.pl";
solid_PVDIS_target_enclosure("LD2");
solid_PVDIS_target_enclosure("LH2");
