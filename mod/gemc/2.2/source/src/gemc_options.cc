...
void goptions::setGoptions()
{
	...
	optMap["MERGE_FILE"].args  = "no";
	optMap["MERGE_FILE"].name  = "Merge banks from filename.";
	optMap["MERGE_FILE"].help  = "Merge banks from filename. Format supported: \n";
	optMap["MERGE_FILE"].help += "      - EVIO";
	optMap["MERGE_FILE"].type  = 1;
	optMap["MERGE_FILE"].ctgr  = "control";
