...
$configuration{"detector_name"} = "solid_PVDIS_real";
...
require "solid_PVDIS_gem_real.pl";
solid_PVDIS_gem_real();
...
#hit
require "./solidgem_hit.pl";
define_solidgem_hit();
require "./solidec_hit.pl";
define_solidec_hit();

# banks
require "./solidgem_bank.pl";
define_solidgem_bank();
require "./solidec_bank.pl";
define_solidec_bank();