...
map<string, gBank> read_banks(goptions gemcOpt, map<string, string> allSystems)
{
	...
	abank.load_variable("evn",        2, "Ni", "Event Number");
	abank.load_variable("evn_type",   3, "Ni", "Event Type. 1 for physics events, 10 for scaler. Negative sign for MC.");
	abank.load_variable("beamPol",    4, "Nd", "Beam Polarization");
	abank.load_variable("var1",       5, "Nd", "User defined. In LUND this was: Target Polarization");
	abank.load_variable("var2",       6, "Nd", "User defined. In LUND this was: Number of nucleons in the target");
	abank.load_variable("var3",       7, "Nd", "User defined. In LUND this was: Number of protons in the target");
	abank.load_variable("var4",       8, "Nd", "User defined. In LUND this was: Bjorken x");
	abank.load_variable("var5",       9, "Nd", "User defined. In LUND this was: Fraction of energy loss");
	abank.load_variable("var6",      10, "Nd", "User defined. In LUND this was: W square");
	abank.load_variable("var7",      11, "Nd", "User defined. In LUND this was: Q square");
	abank.load_variable("var8",      12, "Nd", "User defined. In LUND this was: Energy loss");
	abank.orderNames();
	banks["header"] = abank;
	...
	abank.load_variable("totEdep", 7,   "Rd", "Total Energy Deposited");
	abank.load_variable("avg_x",   8,   "Rd", "Average X position in global reference system");
	abank.load_variable("avg_y",   9,   "Rd", "Average Y position in global reference system");
	abank.load_variable("avg_z",  10,   "Rd", "Average Z position in global reference system");
	abank.load_variable("avg_lx", 11,   "Rd", "Average X position in local reference system");
	abank.load_variable("avg_ly", 12,   "Rd", "Average Y position in local reference system");
	abank.load_variable("avg_lz", 13,   "Rd", "Average Z position in local reference system");
	...
	abank.load_variable("vx",     17,   "Rd", "x component of primary vertex of the particle entering the sensitive volume");
	abank.load_variable("vy",     18,   "Rd", "y component of primary vertex of the particle entering the sensitive volume");
	abank.load_variable("vz",     19,   "Rd", "z component of primary vertex of the particle entering the sensitive volume");
	abank.load_variable("mvx",    20,   "Rd", "x component of primary vertex of the mother of the particle entering the sensitive volume");
