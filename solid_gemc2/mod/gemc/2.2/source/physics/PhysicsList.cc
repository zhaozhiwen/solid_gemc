...
//		opticalPhysics->SetTrackSecondariesFirst(kScintillation, true);
		...
		// setting verbosity of optical processes
		// the process index is in G4OpticalProcessIndex
		// currently: 8 items
		for(unsigned i=0; i<8; i++)
			opticalPhysics->SetProcessVerbose(i, 0);
		
		// also: look at G4OpticalPhysics for details
