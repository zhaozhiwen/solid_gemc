...
vector<MHit*> solid_mrpc_HitProcess :: electronicNoise()
{
...
map< int, vector <double> > solid_mrpc_HitProcess :: chargeTime(MHit* aHit, int hitn)
{
...
double solid_mrpc_HitProcess :: voltage(double charge, double time, double forTime)
{
	return 0.0;
}
