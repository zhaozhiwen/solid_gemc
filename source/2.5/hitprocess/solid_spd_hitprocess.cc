...
vector<MHit*> solid_spd_HitProcess :: electronicNoise()
{
...
map< int, vector <double> > solid_spd_HitProcess :: chargeTime(MHit* aHit, int hitn)
{
...
double solid_spd_HitProcess :: voltage(double charge, double time, double forTime)
{
	return 0.0;
}
